...
export const goals = ["main", "main", "main"]
import { DeliveryDriverPartII } from "../level/levels/DeliveryDriverPartII"
export const level = DeliveryDriverPartII
...
// ...but not this
if (false) {
    say("You'll never hear this message.")
}
```
...
<Goal index={2}>Add some flair to the code inside that <DocLink symbol="if">`if`</DocLink> <DocLink symbol="statement">statement</DocLink>. Party time! 🎉</Goal>
