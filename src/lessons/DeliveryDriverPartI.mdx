...
Using this <DocLink symbol="function">function</DocLink>, we can tell the distance between me and the car--very handy for avoiding a collision! We'll actually deliver the parcel in <Ref chapter={2} section={3}>the next section</DocLink>, but for let's practise moving parcels around.
